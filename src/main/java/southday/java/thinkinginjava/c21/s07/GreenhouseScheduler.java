...
public class GreenhouseScheduler {
    ...
    period: 连续两次执行的间隔时间 => 第n次 ---- period ----> 第n+1次
     */
    ...
    class LightOn implements Runnable {
        public void run() {
            ...
            light = true; // volatile guarantee consistency
        }
    }
    ...
    class ThermostatNight implements Runnable {
        public void run() {
            ...
            setThermostat("Night"); // synchronized
        }
    }
    ...
    static class DataPoint {
        ...
        public String toString() {
            return time.getTime() + String.format(" temperature: %.1f humidity: %.2f", temperature, humidity);
        }
    }
    ...
    class CollectData implements Runnable {
        public void run() {
            ...
            synchronized (GreenhouseScheduler.this) {
                // pretend the interval(间隔) is longer than it is:
                ...
                // For a basic object like Calendar. clone(0 is Ok
