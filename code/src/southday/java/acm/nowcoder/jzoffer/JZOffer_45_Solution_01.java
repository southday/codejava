...
public class JZOffer_45_Solution_01 {
    ...
    public boolean isContinuous(int [] numbers) {
        ...
        int i = cnt, need = numbers[i], v = numbers[i];
        while (i < numbers.length && cnt >= 0) {
            if (numbers[i] == need) {
                v = numbers[i];
                need++;
                i++;
        ...
        return i == numbers.length && cnt == 0;
    }
    
    public static void main(String[] args) {
        JZOffer_45_Solution_01 o = new JZOffer_45_Solution_01();
        int numbers[] = {1,3,0,0,5};
        System.out.println(o.isContinuous(numbers));
    }
}
